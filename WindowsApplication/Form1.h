...
/** \file Form1.h
	\brief This header file discribes a Windows Form
...
namespace RC_Cars {
	...
	/// This Windows Form Application tracks and controlls a RC-car
	/**The goal of this form application is to track a RC-car with the help of the Vicon system and to controll
	...
	protected:
		///Destructor
		/**The destructor delets all components of the form.*/
		~Form1()
		{
			if (components)
			{
	...
	///clicking this button sets the velovity setpoint to zero (stops the car)
	private: System::Windows::Forms::Button^  button1;
	///This pictureBox is used to visualize the position of the car in the Coordinate system
	private: System::Windows::Forms::PictureBox^  pictureBox1;
	///This textBox displays/sets the value of KP for the steering controll
	private: System::Windows::Forms::TextBox^  textBox1;
	///This textBox displays/sets the value of Tn for the steering controll
	private: System::Windows::Forms::TextBox^  textBox2;
	///This textBox displays/sets the value of Tv for the steering controll
	private: System::Windows::Forms::TextBox^  textBox3;
	///This textBox displays/sets the value of KP for the velocity controll
	private: System::Windows::Forms::TextBox^  textBox4;
	///This textBox displays/sets the value of Tn for the velocity controll
	private: System::Windows::Forms::TextBox^  textBox5;
	///This textBox displays/sets the value of Tv for the velocity controll
	private: System::Windows::Forms::TextBox^  textBox6;
	///This textBox displays/sets the setpoint radius for the steering controll
	private: System::Windows::Forms::TextBox^  textBox7;
	///This trackBar sets the setpoint of the velocity control
...
/**The main work of this application is done by this funktion.
An infinite loop runs in this funktion until it receives the cancelation signal. Before entering the loop
two controller objects are created from PID_Controller, a Serial is creatert and a text file is opend.
...
private: System::Void backgroundWorker1_DoWork(System::Object^  sender, System::ComponentModel::DoWorkEventArgs^  e) {
			...
			//set old coordinates to current coordinates, this prevents an instantanious jump of the car in the first loop

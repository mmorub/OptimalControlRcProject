...
namespace RC_Cars {
	...
	public:
		///Constructor
		/**The constructor calls two funktions, first InitializeComponent() which it autogenerated by VS and
		initializes all form components (buttons, text boxes, etc.). The second funktion createClient() is
		defined in ClientCreator.h and creates a Client for the Vicon tracking system.*/
		Form1(void)
		{
			InitializeComponent();
			createClient();
	...
	protected:
		///Destructor
		/**The destructor disconnects the Client for the Vicon tracking system using the funktion
		disconnectClient() than can be found in ClientCreator.h. After the Client is disconnected all
